# -*- coding: utf-8 -*-
"""
Created on Wed Dec  6 15:02:45 2023
...
#ABI key connection
def Api_connect():
    Api_Id="AIzaSyA2GY6OM_0uCmlB2htevmc_SjdcqNah0dk"
...
def main():
    ...
    if question=="1. All the video and the channel name":
        ...
        query2='''select channel_name as channelname,total_video as no_video from channels
                     order by total_video desc'''
        cursor.execute(query2)
        mydb.commit()
        t2=cursor.fetchall()
        df2=pd.DataFrame(t2,columns=["channel name","No of video"])
        st.write(df2)
    ...
    elif question=="5. video with higest Likes":
        ...
        query10='''select title as videotitle,channel_name as channelname,comments as comments from video where comments 
